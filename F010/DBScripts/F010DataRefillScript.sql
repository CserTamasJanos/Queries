...
VALUES (1, 'Egypólusú kapcsoló', 'Egy fogyasztó (pl.lámpatest) egy helyrõl történõ kapcsolására alkalmas.
Elhelyezése: beltér, kivéve vizes, nedves helyiségek.', 550, 12, 1, 1)

INSERT INTO Product (ProductID,ProductName,ProductDescription,ProductListPrice,WarrantyPeriod,ProductCategoryID,ProductStatus)
VALUES (2,'Csiszoló korong', 'A lamellás csiszolótányér vászonból készült csiszolólamellái legyezõszerû, sugaras elrendezõdésének köszönhetõen a szokványos szerszámok csiszolási teljesítményének többszörösét éri el. A lamellás csiszolótányér egyenes kivitelû.
Egyenletes csiszolat a szerszám teljes elhasználódásáig. Nagy leválasztási teljesítmény. Aluminium-oxid (korund) szemcséjû.', 200, 1, 2, 1)
...
INSERT INTO Product (ProductID,ProductName,ProductDescription,ProductListPrice,WarrantyPeriod,ProductCategoryID,ProductStatus)
VALUES (6, 'Körzõ','Maped Körzõ készlet, rögzíthetõ lábakkal, 7 darabos', 1500, 12, 3, 0)
...
INSERT INTO Product (ProductID,ProductName,ProductDescription,ProductListPrice,WarrantyPeriod,ProductCategoryID,ProductStatus)
VALUES (9, 'Körzõ','Rotring, kiváló minõségû iskolai körzõ, A szett körzõ hegyet is tartalmaz, Mûanyag tárolódobozban', 2000, 12, 3, 0)
