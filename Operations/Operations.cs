...
namespace Operations
{
    public static class SQLWay
    {
        ...
        public static List<Productcategory> productCategoryList = new List<Productcategory>();
        public static List<CustomerOrder> customerOrderList = new List<CustomerOrder>();
        public static List<OrderedProduct> orderedProductList = new List<OrderedProduct>();
        ...
        public static bool AllProductCategoryDataDownload()
        {
            ...
            try
            {
                using (SqlConnection connection = new SqlConnection(QueryStrings.ServerConnetion))
                {
                    ...
                    while (reader.Read())
                    {
                        productCategoryList.Add(new Productcategory(Convert.ToInt32(reader[0]), reader[1].ToString()));
                    }
                }
            }
            catch (Exception a)
        ...
        public static bool AllProductDataDownload()
        {
            ...
            try
            {
                using (SqlConnection connection = new SqlConnection(QueryStrings.ServerConnetion))
                {
                    ...
                    while (reader.Read())
                    {
                        productList.Add(new Product(Convert.ToInt32(reader[0]), reader[1].ToString(), reader[2].ToString(),
        ...
        public static bool AllCustomerDataDownload()
        {
            ...
            try
            {
                using (SqlConnection connection = new SqlConnection(QueryStrings.ServerConnetion))
                {
                    ...
                    while (reader.Read())
                    {
                        customerList.Add(new Customer(Convert.ToInt32(reader[0]), reader[1].ToString(), reader[2].ToString(), reader[3].ToString(),
        ...
        public static bool AllCustomerOrderDataDownload()
        {
            ...
            try
            {
                using (SqlConnection connection = new SqlConnection(QueryStrings.ServerConnetion))
                {
                    ...
                    while (reader.Read())
                    {
                        customerOrderList.Add(new CustomerOrder(Convert.ToInt32(reader[0]), Convert.ToDateTime(reader[1]),
                            Convert.ToInt32(reader[2]), Convert.ToInt32(reader[3]), Convert.ToInt32(reader[4])));
                    }
                }
            }
